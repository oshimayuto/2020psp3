...
113.出発点をPush
115~118.visitedを初期化
120~135.stackが空でないときstackから1つ取り出し、行ったことないならば行ったことにし、その場所から行けるところをstackに入れる
...
217.Queueを初期化
218.出発点をキューに入れる
210~236.キューのキューがから出ないとき、キューから1つ取り出し、行ったことがないなら行ったことにして、その場所から行けるところをキューに入れる
